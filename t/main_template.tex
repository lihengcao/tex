...
\usepackage{amsmath, amssymb, amsthm, graphicx, hyperref, enumerate, multirow,  multicol, tikz, centernot, forest, lipsum, mathtools, bm, fancyhdr, float, parskip}

\usepackage{comment} % everything inside comment environment gets ignored
\usepackage{esdiff, esvect} % differentiation, vector notation
\usepackage{cancel} % draw diagonal line meaning cancel
